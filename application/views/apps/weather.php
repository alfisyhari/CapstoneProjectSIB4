    ...
    <main>
      <section id="weatherInputCity" class="container pt-5">
        <div class="mb-3">
          ...
          <div class="form-text text-muted"><small>Example: Yogyakarta, Lombok, Bandung</small></div>
          <button id="getWeather" type="button" class="btn btn-primary mt-3">Get Weather</button>
        </div>
      </section>
