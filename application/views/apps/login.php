...
<body>
    <main id="form-login" class="container-fluid min-vh-100">
        <section class="border border-black p-6">
            <form class="row g-3 m-auto" action="<?= site_url('Login/process_login') ?>" method="post">
                ...
                <div class="col-5 py-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="remember-me" name="remember_me" required>
                ...
                <div class="col py-3 text-end">
                    <a href="<?= base_url('index.php/ForgotPassword')?>">Forgot Password?</a>
                </div>
                <div class="col-12">
                    <button class="btn btn-primary w-100 fs-4" type="submit">Login</button>
                </div>
            </form>
        </section>
    </main>
