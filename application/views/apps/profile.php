              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <div class="form-control bg-light"><?= $this->session->userdata('name') ?></div>
                  </div>
                </div>
                <div class="col">
                  <div class="form-group">
                    <label for="">USERNAME</label>
                    <div class="form-control bg-light"><?= $this->session->userdata('username') ?></div>
                  </div>
                </div>
              </div>
              <div class="row mt-3">
                <div class="col">
                  <div class="form-group">
                    ...
                    <div class="form-control bg-light"><?= $this->session->userdata('gender') ?></div>
                  </div>
                </div>
                <div class="col">
                  <div class="form-group">
                    <label for="">PHONE</label>
                    <div class="form-control bg-light"><?= $this->session->userdata('phone') ?></div>
                  </div>
                </div>
              </div>
            </div>
